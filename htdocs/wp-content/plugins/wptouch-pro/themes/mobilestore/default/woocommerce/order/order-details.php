...
<?php
	if ( $order->billing_email ) echo '<dt>' . __( 'Email', 'wptouch-pro' ) . '</dt><dd>' . $order->billing_email . '</dd>';
	if ( $order->billing_phone ) echo '<dt>' . __( 'Telephone', 'wptouch-pro' ) . '</dt><dd>' . $order->billing_phone . '</dd>';
