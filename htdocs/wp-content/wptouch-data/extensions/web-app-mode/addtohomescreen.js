...
ath.defaults = {
	...
	language: 'en_us',			// Language for the message bubble
...
ath.Class = function (options) {
	...
	if ( options && this.options.language ) {
		// falls back to en_us if language is unsupported
			
		ath.language = this.options.language  && this.options.language in ath.intl ? this.options.language : 'en_us';
	}
