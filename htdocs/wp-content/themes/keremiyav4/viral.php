...
get_header();
	...
	echo '<div class="filmborder1"><h1  align="center" style="font-family: Arial;"><strong>Επιλεγμένες μερικές από τις καλύτερες ταινίες του 2018 (VIRAL MOVIES)</strong></h1>';
	...
	<?php
		echo do_shortcode('[ajax_load_more seo="true" cache_id="cache-viral" id="viral" cache="true" preloaded="true" preloaded_amount="10" posts_per_page="10" button_label="More Movies" category="viral"]');
			echo '&nbsp;';
	echo '</div>';
	echo '</div>';
	echo '</div>';
