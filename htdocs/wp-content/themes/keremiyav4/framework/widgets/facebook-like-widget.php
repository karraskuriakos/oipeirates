...
class Facebook_Like_Widget extends WP_Widget {
	...
	{
		$widget_ops = array('classname' => 'facebook_like', 'description' => 'Facebook sayfanız için kutu oluşturur.');

		$control_ops = array('id_base' => 'facebook-like-widget');

		$this->WP_Widget('facebook-like-widget', '+ Keremiya Facebook Beğeni Kutusu', $widget_ops, $control_ops);
	}
