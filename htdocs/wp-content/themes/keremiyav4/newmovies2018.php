...
get_header();
	...
	echo '<div class="filmborder1"><h1  align="center" style="font-family: Arial;"><strong>ΚΑΙΝΟΥΡΙΕΣ ΤΑΙΝΙΕΣ (2018)</strong></h1>';
	...
	<?php
		echo do_shortcode('[ajax_load_more seo="true" cache_id="cache-2018" id="2018" cache="true" preloaded="true" preloaded_amount="10" posts_per_page="10" button_label="More Movies" category="2018"]');
			echo '&nbsp;';
	echo '</div>';
	echo '</div>';
	echo '</div>';
